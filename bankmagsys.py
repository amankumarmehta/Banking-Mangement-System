...
def create():                                                           # function for creating account
    ...
    while ans=='y':
        while True:
            a=None
            print("\nWHICH TYPE OF ACCOUNT U WANT TO CREATE\n 1 - FIXED ACCOUNT\n 2 - LOAN ACCOUNT")
            a=int(input("Enter your Choice="))
            if a==1:
                accno=random.randint(10000000,99999999)                     # using random module generating account no.
                r=acc_no(accno)
                if r==1:
                    break
            elif a==2:
        ...
        deposit=int(input("Deposit Minimum rs 500= "))                      # condition for deposit money
        while deposit<500:
...
def all_details():                                                          # function for all account details
    ...
    try:
        ...
        print('='*120)
        f.close    
def detail():                                                               # function for specific account details                                                                      
    f=open("bank.dat","rb")
    ...
    try:
        ...
        if found==False:
            print("Account Not Found.....\n(May password or account no. incorrect)")
        f.close()  
...
def withdraw():                                                     # function for withdraw money
    ...
    try:
        ...
        while True:
            ...
            rec=pickle.load(f)
            if rec[0]==accno and rec[7]==passwd:
                d=int(input("Enter Money To Be Withdrawn "))
